...
class SwerveModule(
    ...
    init {
        ...
        val driveMotorConfig = driveMotor.configuration
        ...
        val steerMotorConfig = steerMotor.configuration
    ...
    fun applyTelePIDValues() {
        setDrivePingu(networkPinguDrive.pingu)
        setSteerPingu(networkPinguSteer.pingu)
    }
